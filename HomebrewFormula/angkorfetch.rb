class Angkorfetch < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/AMRSKH/angkorfetch/releases/download/v1.2.0/angkorfetch-macos-aarch64.tar.gz"
      sha256 "b6c46e0e24c9f2fc10349dbe447302ccd9a02b098c287a627353e81199bb1cc9"
    else
      url "https://github.com/AMRSKH/angkorfetch/releases/download/v1.2.0/angkorfetch-macos-x86_64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
      url "https://github.com/AMRSKH/angkorfetch/releases/download/v1.2.0/angkorfetch-linux-aarch64.tar.gz"
      sha256 "06add6a4aab05eb4ed8061dc487099d2b8f3c203701aa2ab699f18f35399ce93"
    else
      url "https://github.com/AMRSKH/angkorfetch/releases/download/v1.2.0/angkorfetch-linux-x86_64.tar.gz"
